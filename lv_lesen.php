...
if ($modus === 'bedarf') {
    ...
    $anweisung = 'Du bist ein Assistent fuer einen Fliesenleger-Betrieb. '
        ...
        . '"bedarf" (true oder false), '
        . '"kategorie" (GENAU einer dieser Schluessel - klassifiziere, WAS in der Position getan wird). '
        . 'Erlaubte Schluessel fuer "kategorie": '
        . 'wand (Wandfliesen verlegen), boden (Bodenfliesen verlegen), laibung (Fensterlaibung/Ablage/Innenfensterbank verfliesen), '
        . 'zulage_gefaelle (Zulage fuer Verlegung im Gefaelle), naturstein, betonwerkstein (Betonwerksteinplatten Boden), '
        . 'treppenbelag (Fliesen auf Treppenstufen), werksteinstufe (fertige Tritt-/Setz-/Winkelstufen aus Betonwerkstein, nach Stueck), '
        . 'sockel (Sockelfliesen/Sockelleisten je Meter), fensterbank (Naturstein-/Agglo-Fensterbank), '
        . 'spiegel (Wandspiegel), revision (Revisionsunterlagen/Dokumentation), matte_anarbeiten (Sauberlaufmatte einfliesen), '
        . 'schraegschnitt (Zulage Schraegschnitte), ueberschrift (reine Ueberschrift/Vorbemerkung ohne Leistung), '
        . 'abdicht_flaeche (Flaechenabdichtung/Dichtschlaemme/Dichtfolie/Dichtbahn), dichtband, manschette, dichtecke, '
        . 'grundierung, spachtel (Ausgleich/Spachtelung), entkopplung (Entkopplungsmatte), stundenlohn, '
        . 'profil (Schienen/Profile/Kantenschutz je Meter), reservefliesen, loch (Loch/Anschnitt/Bohrung je Stueck), '
        . 'ablauf (Bodenablauf anarbeiten), hohlkehlsockel, rohrkasten, '
        . 'duschelement (das ELEMENT liefern/einbauen oder Mosaik darauf verlegen), fliesentausch, '
        . 'silikon (dauerelastische Verfugung), randfuge (Randdaemmstreifen), schutz (Belag abdecken/schuetzen), '
        . 'reinigung, behandlung (Impraegnierung/Einpflege), sauberlaufmatte, sauberlaufrahmen, baustelle (Baustelleneinrichtung), '
        . 'unbekannt (wenn wirklich unklar). '
        . 'WICHTIG zur Kategorie: Die TAETIGKEIT bestimmt sie, nicht das genannte Bauteil. '
        . '"Estrichflaeche/Duschelement abdichten" ist abdicht_flaeche (das Duschelement ist nur der Untergrund). '
        . '"Zulage fuer Verlegung im Gefaelle" ist zulage_gefaelle, kein duschelement. '
        . '"Sockelleiste ... Verlegung im Duennbett" ist sockel, kein boden - auch wenn der Text den Bodenbelag erwaehnt. '
        . 'Eine Ueberschrift oder Vorbemerkung ohne eigene Leistung ist ueberschrift. '
        ...
        . 'Beispiel des erwarteten Formats: '
        . '[{"pos":"01.001","beschreibung":"Bodenfliesen 30x60 verlegen","langtext":"Liefern und Verlegen von Bodenfliesen im Format 30x60 cm, Farbe nach Wahl des AG, im Duennbettverfahren auf vorbereitetem Untergrund, inkl. Verfugung...","menge":45.5,"einheit":"m2","bedarf":false,"kategorie":"boden"},'
        . '{"pos":"01.002","beschreibung":"Sockelfliesen","langtext":"***Bedarfsposition - Nur EP -  Sockelfliesen liefern und einbauen, Hoehe ca. 60 mm...","menge":97,"einheit":"m","bedarf":true,"kategorie":"sockel"}]';
    $ergebnisFeld = 'positionen';
}
